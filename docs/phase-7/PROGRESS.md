...
| 2 | V2.1 | `withStates` on polar/geo | merged | `ses_f8e277e8fffeFjKx9XQ1oKJ1yO` | (next commit) | D528 · `withStates` on pie/radar/sunburst polar containers + choropleth `geoShape` · states fixture exit 0 · 3 D424 drops restored · sankey states = library-cannot at 0.16.0 → V3.2 · reactive dims stay until V2.2 deletes them |
