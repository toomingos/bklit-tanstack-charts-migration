...
| 2 | V1.3 | registering children | merged | `ses_f8e2786caffe0MKE485qxGYfHD` | (next commit) | D527 · registry provider in `ChartHost` · `roleOf` unwraps memo/forwardRef (R5) · hoc fixture exit 0 · plain-wrapper end-to-end waits for G6 (entries render `{children}` in the host) |
