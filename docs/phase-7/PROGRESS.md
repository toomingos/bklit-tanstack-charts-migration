...
| 3 | V2.2 choropleth | package pointer on `geoShape`, delete `choropleth-hover-chrome.ts` | merged | `ses_f8df31363ffemCraJgg3s2V47c` | (next commit) | D534 · `ChartFocusStrategy` owns the feature pointer · hover chrome deleted · QA choropleth/100 0 / 791 / 697 / 1348 (baseline 0 / 2669 / 4687 / 4305) |
