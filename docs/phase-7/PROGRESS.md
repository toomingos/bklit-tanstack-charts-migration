...
| 3 | V2.4 | decorative tooltip springs | merged | `ses_f8c458e10ffe1gQA90dmS1bisd` | __V24C__ | D542 · 7 files +107/−701 · `setAttribute\|createSpring` in tooltip-* = 0 · QA line/area/bar/candlestick/scatter equal to the V1.2 run, all PASS |
