...
| 2 | V3.3 | heatmap on band scales | merged | `ses_f8e27770effe1nrPt7XO6YzT69` | (next commit) | D526 · 39 → 13 modules · `.range(`/portal/observer in heatmap = 0 · QA 4/4 PASS (+≈500 px vs baseline) · band instances, not factories (ruling) |
