...
export function LineChart({
  ...
  const definition = React.useMemo(() => {
    ...
    const marks: ChartMark<ChartDatum, Date, number>[] = lines.map((line) =>
      lineY(renderData, {
        id: line.dataKey,
    ...
    return defineChart({
      ...
      animate:
        phaseRef.current === "ready" && yDomainTween && yDomainChanged
          ? { duration: yDomainTweenDuration, easing: bezierEasing }
          : false,
    });
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [renderData, xDataKey, lines, grid, width, yDomain, margin.top, margin.right, margin.bottom, margin.left]);
