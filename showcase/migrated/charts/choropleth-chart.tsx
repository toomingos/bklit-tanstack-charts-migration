...
import { findRevealRoot, isRevealed, markRevealed } from "./internal/reveal-root";
...
// Features enter through the renderer; the hook keeps the pending/seen tracking for replays.
