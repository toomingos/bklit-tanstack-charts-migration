// Same tree/props as bklit-gauge.tsx; import source only (settle tail differs, see below).
...
// GUARD: 712, NOT bklit's 450 (baked WAAPI tween vs live spring; 450 under-reports M1b).
...
// Covers the render-to-effect gap before the WAAPI reveal timeline starts.
