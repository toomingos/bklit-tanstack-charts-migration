// Docs-demo basis (registry funnel example passes nonexistent aspectRatio).
...
// Phase-less chart (no onPhaseChange): manual settle from source stagger+duration: (n-1)*120+1100ms.
...
export default function BklitFunnel({ n }: { n: number }) {
  ...
  useEffect(() => {
    ...
    // n = stage count, not a window: no live-append; no-op keeps the global present.
