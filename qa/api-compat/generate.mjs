...
const lines = [
  ...
  "// V4.2 parity fixture: one Eq<> per legacy barrel export (10-parity-contract §1).",
  "// Eq = mutual assignability (D550): a legacy call site compiles against the migrated export and the migrated",
  "// result is usable where the legacy one was. `readonly` modifiers, which TypeScript ignores for assignment, do not count.",
